...
EVENT_MERGED_DTYPE = [('time', '<i8'), ('endtime', '<i8'), ('cut_fiducial_volume', '?'), ('cut_ar37_kshell_area', '?'), ('cut_clipped_events', '?'), ('cut_cs2_area_fraction_top', '?'), ('cut_daq_veto', '?'), ('cut_interaction_exists', '?'), ('cut_main_is_valid_triggering_peak', '?'), ('cut_s1_area_fraction_top', '?'), ('cut_s1_max_pmt', '?'), ('cut_s1_pattern_bottom', '?'), ('cut_s1_pattern_top', '?'), ('cut_s1_single_scatter', '?'), ('cut_s2_pattern', '?'), ('cut_s2_recon_pos_diff', '?'), ('cut_s2_single_scatter', '?'), ('cut_s2_width', '?'), ('cuts_ar37_kshell_s1s2', '?'), ('cs1', '<f4'), ('cs2_wo_elifecorr', '<f4'), ('cs2_wo_timecorr', '<f4'), ('cs2_area_fraction_top', '<f4'), ('cs2_bottom', '<f4'), ('cs2', '<f4'), ('alt_cs1', '<f4'), ('alt_cs2_wo_elifecorr', '<f4'), ('alt_cs2_wo_timecorr', '<f4'), ('alt_cs2_area_fraction_top', '<f4'), ('alt_cs2_bottom', '<f4'), ('alt_cs2', '<f4'), ('e_light', '<f4'), ('e_charge', '<f4'), ('e_ces', '<f4'), ('n_peaks', '<i4'), ('drift_time', '<f4'), ('event_number', '<i8'), ('s1_index', '<i4'), ('alt_s1_index', '<i4'), ('s1_time', '<i8'), ('alt_s1_time', '<i8'), ('s1_center_time', '<i8'), ('alt_s1_center_time', '<i8'), ('s1_endtime', '<i8'), ('alt_s1_endtime', '<i8'), ('s1_area', '<f4'), ('alt_s1_area', '<f4'), ('s1_n_channels', '<i2'), ('alt_s1_n_channels', '<i2'), ('s1_n_competing', '<i4'), ('alt_s1_n_competing', '<i4'), ('s1_max_pmt', '<i2'), ('alt_s1_max_pmt', '<i2'), ('s1_max_pmt_area', '<f4'), ('alt_s1_max_pmt_area', '<f4'), ('s1_range_50p_area', '<f4'), ('alt_s1_range_50p_area', '<f4'), ('s1_range_90p_area', '<f4'), ('alt_s1_range_90p_area', '<f4'), ('s1_rise_time', '<f4'), ('alt_s1_rise_time', '<f4'), ('s1_area_fraction_top', '<f4'), ('alt_s1_area_fraction_top', '<f4'), ('s1_tight_coincidence', '<i2'), ('alt_s1_tight_coincidence', '<i2'), ('s1_n_saturated_channels', '<i2'), ('alt_s1_n_saturated_channels', '<i2'), ('alt_s1_interaction_drift_time', '<f4'), ('alt_s1_delay', '<i4'), ('s2_index', '<i4'), ('alt_s2_index', '<i4'), ('s2_time', '<i8'), ('alt_s2_time', '<i8'), ('s2_center_time', '<i8'), ('alt_s2_center_time', '<i8'), ('s2_endtime', '<i8'), ('alt_s2_endtime', '<i8'), ('s2_area', '<f4'), ('alt_s2_area', '<f4'), ('s2_n_channels', '<i2'), ('alt_s2_n_channels', '<i2'), ('s2_n_competing', '<i4'), ('alt_s2_n_competing', '<i4'), ('s2_max_pmt', '<i2'), ('alt_s2_max_pmt', '<i2'), ('s2_max_pmt_area', '<f4'), ('alt_s2_max_pmt_area', '<f4'), ('s2_range_50p_area', '<f4'), ('alt_s2_range_50p_area', '<f4'), ('s2_range_90p_area', '<f4'), ('alt_s2_range_90p_area', '<f4'), ('s2_rise_time', '<f4'), ('alt_s2_rise_time', '<f4'), ('s2_area_fraction_top', '<f4'), ('alt_s2_area_fraction_top', '<f4'), ('s2_tight_coincidence', '<i2'), ('alt_s2_tight_coincidence', '<i2'), ('s2_n_saturated_channels', '<i2'), ('alt_s2_n_saturated_channels', '<i2'), ('alt_s2_interaction_drift_time', '<f4'), ('alt_s2_delay', '<i4'), ('s2_x', '<f4'), ('s2_y', '<f4'), ('alt_s2_x', '<f4'), ('alt_s2_y', '<f4'), ('area_before_main_s2', '<f4'), ('large_s2_before_main_s2', '<f4'), ('s2_x_cnn', '<f4'), ('s2_y_cnn', '<f4'), ('alt_s2_x_cnn', '<f4'), ('alt_s2_y_cnn', '<f4'), ('s2_x_gcn', '<f4'), ('s2_y_gcn', '<f4'), ('alt_s2_x_gcn', '<f4'), ('alt_s2_y_gcn', '<f4'), ('s2_x_mlp', '<f4'), ('s2_y_mlp', '<f4'), ('alt_s2_x_mlp', '<f4'), ('alt_s2_y_mlp', '<f4'), ('x', '<f4'), ('y', '<f4'), ('z', '<f4'), ('r', '<f4'), ('z_naive', '<f4'), ('r_naive', '<f4'), ('r_field_distortion_correction', '<f4'), ('z_field_distortion_correction', '<f4'), ('theta', '<f4')]
